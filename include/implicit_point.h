...
public:
    ...
    // Input can be any combination of 3D points
    static int inSphere(const genericPoint& a,
    ...
    static int maxComponentInTriangleNormal(double v1x,
                                            double v1y,
                                            double v1z,
                                            double v2x,
                                            double v2y,
    ...
    static bool pointInInnerTriangle(const genericPoint& P,
    ...
    static bool pointInTriangle(const genericPoint& P,
                                const genericPoint& A,
                                const genericPoint& B,
                                const genericPoint& C,
                                int&                oAB,
    ...
    {
        return ((n_max == 2 && orient2Dxy(A, B, C)) || (n_max == 0 && orient2Dyz(A, B, C))
    ...
    static bool pointInTriangle(const genericPoint& P,
                                ...
                                const genericPoint& C,
                                int                 n_max);
    static bool innerSegmentsCross(const genericPoint& A,
                                   const genericPoint& B,
                                   const genericPoint& P,
                                   const genericPoint& Q,
                                   int                 n_max);
    static bool segmentsCross(const genericPoint& A,
                              const genericPoint& B,
                              const genericPoint& P,
                              const genericPoint& Q,
                              int                 n_max);
...
public:
    implicitPoint2D_SSI(const explicitPoint2D& l11,
...
public:
    implicitPoint3D_LPI(const explicitPoint3D& _p,
...
public:
    implicitPoint3D_TPI(const explicitPoint3D& _v1,
...
public:
    implicitPoint3D_LNC(const explicitPoint3D& _p, const explicitPoint3D& _q, const double _t);
...
inline ostream& operator<<(ostream& os, const explicitPoint2D& p) { return os << p.X() << " " << p.Y() << " 0"; }
...
inline ostream& operator<<(ostream& os, const explicitPoint3D& p) { return os << p.X() << " " << p.Y() << " " << p.Z(); }
