...
int  inSphere_IEEEE(const genericPoint& p1,
                    double              pbx,
                    double              pby,
                    double              pbz,
                    double              pcx,
                    ...
                    double              pey,
                    double              pez);
int  inSphere_IIEEE(const genericPoint& p1,
                    ...
                    double              pey,
                    double              pez);
int  inSphere_IIIEE(const genericPoint& p1,
                    const genericPoint& p2,
                    ...
                    double              pey,
                    double              pez);
int  inSphere_IIIIE(const genericPoint& p1,
                    const genericPoint& p2,
                    const genericPoint& p3,
                    ...
                    double              pey,
                    double              pez);
int  inSphere_IIIII(const genericPoint& p1,
                    const genericPoint& p2,
                    const genericPoint& p3,
                    const genericPoint& p4,
                    const genericPoint& p5);
bool lambda2d_SSI_interval(interval_number  ea1x,
...
void lambda2d_SSI_exact(double   ea1x,
                        double   ea1y,
                        double   ea2x,
                        double   ea2y,
                        double   eb1x,
                        ...
                        double** lambda_det,
                        int&     lambda_det_len);
void lambda2d_SSI_bigfloat(bigfloat  ea1x,
                           bigfloat  ea1y,
                           bigfloat  ea2x,
                           bigfloat  ea2y,
                           bigfloat  eb1x,
                           ...
                           bigfloat& lambda_y,
                           bigfloat& lambda_det);
bool lambda3d_LNC_interval(interval_number  px,
                           interval_number  py,
                           interval_number  pz,
                           interval_number  qx,
                           interval_number  qy,
...
void lambda3d_LNC_exact(double   px,
                        double   py,
                        double   pz,
                        double   qx,
                        double   qy,
                        ...
                        double** lambda_d,
                        int&     lambda_d_len);
void lambda3d_LNC_bigfloat(bigfloat  px,
                           bigfloat  py,
                           bigfloat  pz,
                           bigfloat  qx,
                           bigfloat  qy,
                           ...
                           bigfloat& lambda_z,
                           bigfloat& lambda_d);
bool lambda3d_LPI_interval(interval_number  px,
                           interval_number  py,
                           interval_number  pz,
                           interval_number  qx,
                           interval_number  qy,
                           ...
                           interval_number& lambda_z,
                           interval_number& lambda_d);
void lambda3d_LPI_exact(double   px,
                        double   py,
                        double   pz,
                        double   qx,
                        double   qy,
                        ...
                        double** lambda_d,
                        int&     lambda_d_len);
void lambda3d_LPI_bigfloat(bigfloat  px,
                           bigfloat  py,
                           bigfloat  pz,
                           bigfloat  qx,
                           bigfloat  qy,
                           ...
                           bigfloat& lambda_z,
                           bigfloat& lambda_d);
bool lambda3d_TPI_interval(interval_number  ov1x,
                           ...
                           interval_number& lambda_z,
                           interval_number& lambda_d);
void lambda3d_TPI_exact(double   ov1x,
                        double   ov1y,
                        double   ov1z,
                        double   ov2x,
                        double   ov2y,
                        ...
                        double** lambda_d,
                        int&     lambda_d_len);
void lambda3d_TPI_bigfloat(bigfloat  ov1x,
                           bigfloat  ov1y,
                           bigfloat  ov1z,
                           bigfloat  ov2x,
                           bigfloat  ov2y,
...
int  orient3d_indirect_IEEE(const genericPoint& p1,
                            double              ax,
                            double              ay,
                            double              az,
                            double              bx,
                            ...
                            double              cy,
                            double              cz);
int  orient3d_indirect_IIEE(const genericPoint& p1,
                            const genericPoint& p2,
                            double              p3x,
                            double              p3y,
                            double              p3z,
                            ...
                            double              p4y,
                            double              p4z);
int  orient3d_indirect_IIIE(const genericPoint& p1,
                            const genericPoint& p2,
                            const genericPoint& p3,
                            double              p4x,
                            double              p4y,
