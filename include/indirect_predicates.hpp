...
inline int dotProductSign2D_interval(interval_number px,
                                     interval_number py,
                                     interval_number rx,
                                     interval_number ry,
                                     interval_number qx,
...
inline int
    dotProductSign3D_filtered(double px, double py, double pz, double rx, double ry, double rz, double qx, double qy, double qz)
{
    const double lx = px - qx;
    const double ly = py - qy;
...
inline int dotProductSign3D_interval(interval_number px,
                                     interval_number py,
                                     interval_number pz,
                                     interval_number rx,
                                     interval_number ry,
...
inline int dotProductSign3D_bigfloat(bigfloat px,
                                     bigfloat py,
                                     bigfloat pz,
                                     bigfloat rx,
                                     bigfloat ry,
...
inline int
    dotProductSign3D_exact(double px, double py, double pz, double rx, double ry, double rz, double qx, double qy, double qz)
{
    double lx[2];
    expansionObject::two_Diff(px, qx, lx);
    double ly[2];
...
inline int incircle_interval(interval_number pax,
                             interval_number pay,
                             interval_number pbx,
                             interval_number pby,
                             interval_number pcx,
...
inline int incircle_bigfloat(bigfloat pax,
                             bigfloat pay,
                             bigfloat pbx,
                             bigfloat pby,
                             bigfloat pcx,
...
inline int inSphere_filtered(double pax,
                             double pay,
                             double paz,
                             double pbx,
                             double pby,
...
inline int inSphere_interval(interval_number pax,
                             interval_number pay,
                             interval_number paz,
                             interval_number pbx,
                             interval_number pby,
...
inline int inSphere_bigfloat(bigfloat pax,
                             bigfloat pay,
                             bigfloat paz,
                             bigfloat pbx,
                             bigfloat pby,
...
inline int inSphere_exact(double pax,
                          double pay,
                          double paz,
                          double pbx,
                          double pby,
...
inline int inSphere(double pax,
                    double pay,
                    double paz,
                    double pbx,
                    double pby,
...
inline int dotProductSign2D_EEI_interval(const genericPoint& q,
                                         interval_number     px,
                                         interval_number     py,
                                         interval_number     rx,
                                         interval_number     ry)
{
    ...
    if (!q.getIntervalLambda(lqx, lqy, dq)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign2D_IEE_interval(const genericPoint& p,
                                         interval_number     rx,
                                         interval_number     ry,
                                         interval_number     qx,
                                         interval_number     qy)
{
    ...
    if (!p.getIntervalLambda(lpx, lpy, dp)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign2D_IEI_interval(const genericPoint& p, const genericPoint& q, interval_number rx, interval_number ry)
{
    ...
    if (!p.getIntervalLambda(lpx, lpy, dp) || !q.getIntervalLambda(lqx, lqy, dq)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign2D_IEI_exact(const genericPoint& p, const genericPoint& q, double rx, double ry)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double lpx_p[64], *lpx = lpx_p, lpy_p[64], *lpy = lpy_p, dp_p[64], *dp = dp_p, lqx_p[64], *lqx = lqx_p, lqy_p[64],
...
inline int dotProductSign2D_IIE_interval(const genericPoint& p, const genericPoint& r, interval_number qx, interval_number qy)
{
    ...
    if (!p.getIntervalLambda(lpx, lpy, dp) || !r.getIntervalLambda(lrx, lry, dr)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign2D_IIE_exact(const genericPoint& p, const genericPoint& r, double qx, double qy)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double lpx_p[64], *lpx = lpx_p, lpy_p[64], *lpy = lpy_p, dp_p[64], *dp = dp_p, lrx_p[64], *lrx = lrx_p, lry_p[64],
                      *lry = lry_p, dr_p[64], *dr = dr_p;
...
inline int dotProductSign2D_III_interval(const genericPoint& p, const genericPoint& r, const genericPoint& q)
{
    ...
    if (!p.getIntervalLambda(lpx, lpy, dp) || !r.getIntervalLambda(lrx, lry, dr) || !q.getIntervalLambda(lqx, lqy, dq))
        return Filtered_Sign::UNCERTAIN;
...
#endif
    double lpx_p[64], *lpx = lpx_p, lpy_p[64], *lpy = lpy_p, dp_p[64], *dp = dp_p, lrx_p[64], *lrx = lrx_p, lry_p[64],
                      *lry = lry_p, dr_p[64], *dr = dr_p, lqx_p[64], *lqx = lqx_p, lqy_p[64], *lqy = lqy_p, dq_p[64],
                      *dq = dq_p;
    int lpx_len = 64, lpy_len = 64, dp_len = 64, lrx_len = 64, lry_len = 64, dr_len = 64, lqx_len = 64, lqy_len = 64,
        dq_len = 64;
    p.getExactLambda(&lpx, lpx_len, &lpy, lpy_len, &dp, dp_len);
    r.getExactLambda(&lrx, lrx_len, &lry, lry_len, &dr, dr_len);
    q.getExactLambda(&lqx, lqx_len, &lqy, lqy_len, &dq, dq_len);
...
inline int dotProductSign3D_EEI_interval(const genericPoint& q,
                                         interval_number     px,
                                         interval_number     py,
                                         interval_number     pz,
                                         interval_number     rx,
                                         ...
                                         interval_number     rz)
{
    ...
    if (!q.getIntervalLambda(lqx, lqy, lqz, dq)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign3D_EEI_bigfloat(const genericPoint& q,
                                         bigfloat            px,
                                         bigfloat            py,
                                         bigfloat            pz,
                                         bigfloat            rx,
...
inline int dotProductSign3D_IEE_interval(const genericPoint& p,
                                         interval_number     rx,
                                         interval_number     ry,
                                         interval_number     rz,
                                         interval_number     qx,
                                         ...
                                         interval_number     qz)
{
    ...
    if (!p.getIntervalLambda(lpx, lpy, lpz, dp)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign3D_IEE_bigfloat(const genericPoint& p,
                                         bigfloat            rx,
                                         bigfloat            ry,
                                         bigfloat            rz,
                                         bigfloat            qx,
...
inline int dotProductSign3D_IEI_interval(const genericPoint& p,
                                         ...
                                         interval_number     rz)
{
    ...
    if (!p.getIntervalLambda(lpx, lpy, lpz, dp) || !q.getIntervalLambda(lqx, lqy, lqz, dq)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign3D_IEI_exact(const genericPoint& p, const genericPoint& q, double rx, double ry, double rz)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double lpx_p[64], *lpx = lpx_p, lpy_p[64], *lpy = lpy_p, lpz_p[64], *lpz = lpz_p, dp_p[64], *dp = dp_p, lqx_p[64],
                      *lqx = lqx_p, lqy_p[64], *lqy = lqy_p, lqz_p[64], *lqz = lqz_p, dq_p[64], *dq = dq_p;
...
inline int dotProductSign3D_IIE_interval(const genericPoint& p,
                                         const genericPoint& r,
                                         interval_number     qx,
                                         interval_number     qy,
                                         interval_number     qz)
{
    interval_number lpx, lpy, lpz, dp, lrx, lry, lrz, dr;
    if (!p.getIntervalLambda(lpx, lpy, lpz, dp) || !r.getIntervalLambda(lrx, lry, lrz, dr)) return Filtered_Sign::UNCERTAIN;
...
inline int dotProductSign3D_IIE_exact(const genericPoint& p, const genericPoint& r, double qx, double qy, double qz)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double lpx_p[64], *lpx = lpx_p, lpy_p[64], *lpy = lpy_p, lpz_p[64], *lpz = lpz_p, dp_p[64], *dp = dp_p, lrx_p[64],
                      *lrx = lrx_p, lry_p[64], *lry = lry_p, lrz_p[64], *lrz = lrz_p, dr_p[64], *dr = dr_p;
...
inline int dotProductSign3D_III_interval(const genericPoint& p, const genericPoint& r, const genericPoint& q)
{
    ...
    if (!p.getIntervalLambda(lpx, lpy, lpz, dp) || !r.getIntervalLambda(lrx, lry, lrz, dr)
...
inline int dotProductSign3D_III_exact(const genericPoint& p, const genericPoint& r, const genericPoint& q)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double lpx_p[32], *lpx = lpx_p, lpy_p[32], *lpy = lpy_p, lpz_p[32], *lpz = lpz_p, dp_p[32], *dp = dp_p, lrx_p[32],
                      *lrx = lrx_p, lry_p[32], *lry = lry_p, lrz_p[32], *lrz = lrz_p, dr_p[32], *dr = dr_p, lqx_p[32],
                      *lqx = lqx_p, lqy_p[32], *lqy = lqy_p, lqz_p[32], *lqz = lqz_p, dq_p[32], *dq = dq_p;
    int lpx_len = 32, lpy_len = 32, lpz_len = 32, dp_len = 32, lrx_len = 32, lry_len = 32, lrz_len = 32, dr_len = 32,
        lqx_len = 32, lqy_len = 32, lqz_len = 32, dq_len = 32;
    p.getExactLambda(&lpx, lpx_len, &lpy, lpy_len, &lpz, lpz_len, &dp, dp_len);
    r.getExactLambda(&lrx, lrx_len, &lry, lry_len, &lrz, lrz_len, &dr, dr_len);
    q.getExactLambda(&lqx, lqx_len, &lqy, lqy_len, &lqz, lqz_len, &dq, dq_len);
    if ((dp[dp_len - 1] != 0) && (dr[dr_len - 1] != 0) && (dq[dq_len - 1] != 0)) {
...
inline int incirclexy_indirect_IEEE_interval(const genericPoint& p1,
                                             interval_number     pbx,
                                             interval_number     pby,
                                             interval_number     pcx,
                                             interval_number     pcy,
                                             ...
                                             interval_number     pdy)
{
    ...
    if (!p1.getIntervalLambda(l1x, l1y, l1z, d1)) return Filtered_Sign::UNCERTAIN;
...
inline int incirclexy_indirect_IEEE_bigfloat(const genericPoint& p1,
                                             bigfloat            pbx,
                                             bigfloat            pby,
                                             bigfloat            pcx,
                                             bigfloat            pcy,
...
inline int incirclexy_indirect_IEEE_exact(const genericPoint& p1,
                                          double              pbx,
                                          double              pby,
                                          double              pcx,
                                          double              pcy,
                                          ...
                                          double              pdy)
{
    ...
    if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
        return_value = incirclexy_indirect_IEEE_bigfloat(p1, pbx, pby, pcx, pcy, pdx, pdy);
#endif
...
inline int
    incirclexy_indirect_IEEE(const genericPoint& p1, double pbx, double pby, double pcx, double pcy, double pdx, double pdy)
{
    int ret;
...
inline int incirclexy_indirect_IIEE_interval(const genericPoint& p1,
                                             ...
                                             interval_number     pdy)
{
    ...
    if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) || !p2.getIntervalLambda(l2x, l2y, l2z, d2)) return Filtered_Sign::UNCERTAIN;
...
inline int incirclexy_indirect_IIEE_bigfloat(const genericPoint& p1,
                                             const genericPoint& p2,
                                             bigfloat            pcx,
                                             bigfloat            pcy,
                                             bigfloat            pdx,
...
inline int incirclexy_indirect_IIEE_exact(const genericPoint& p1,
                                          const genericPoint& p2,
                                          double              pcx,
                                          double              pcy,
                                          double              pdx,
                                          double              pdy)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1x_p[32], *l1x = l1x_p, l1y_p[32], *l1y = l1y_p, l1z_p[32], *l1z = l1z_p, d1_p[32], *d1 = d1_p, l2x_p[32],
                      *l2x = l2x_p, l2y_p[32], *l2y = l2y_p, l2z_p[32], *l2z = l2z_p, d2_p[32], *d2 = d2_p;
...
inline int incirclexy_indirect_IIEE(const genericPoint& p1,
                                    const genericPoint& p2,
                                    double              pcx,
                                    double              pcy,
                                    double              pdx,
...
inline int incirclexy_indirect_IIIE_interval(const genericPoint& p1,
                                             const genericPoint& p2,
                                             ...
                                             interval_number     pdy)
{
    ...
    if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) || !p2.getIntervalLambda(l2x, l2y, l2z, d2)
...
inline int incirclexy_indirect_IIIE_bigfloat(const genericPoint& p1,
                                             const genericPoint& p2,
                                             const genericPoint& p3,
                                             bigfloat            pdx,
                                             bigfloat            pdy)
...
inline int incirclexy_indirect_IIIE_exact(const genericPoint& p1,
                                          const genericPoint& p2,
                                          const genericPoint& p3,
                                          double              pdx,
                                          double              pdy)
...
#endif
    double l1x_p[32], *l1x = l1x_p, l1y_p[32], *l1y = l1y_p, l1z_p[32], *l1z = l1z_p, d1_p[32], *d1 = d1_p, l2x_p[32],
                      *l2x = l2x_p, l2y_p[32], *l2y = l2y_p, l2z_p[32], *l2z = l2z_p, d2_p[32], *d2 = d2_p, l3x_p[32],
                      *l3x = l3x_p, l3y_p[32], *l3y = l3y_p, l3z_p[32], *l3z = l3z_p, d3_p[32], *d3 = d3_p;
    int l1x_len = 32, l1y_len = 32, l1z_len = 32, d1_len = 32, l2x_len = 32, l2y_len = 32, l2z_len = 32, d2_len = 32,
        l3x_len = 32, l3y_len = 32, l3z_len = 32, d3_len = 32;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
...
inline int incirclexy_indirect_IIIE(const genericPoint& p1,
                                    const genericPoint& p2,
                                    const genericPoint& p3,
                                    double              pdx,
                                    double              pdy)
...
inline int incirclexy_indirect_IIII_interval(const genericPoint& p1,
                                             const genericPoint& p2,
                                             const genericPoint& p3,
                                             const genericPoint& p4)
{
    ...
    if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) || !p2.getIntervalLambda(l2x, l2y, l2z, d2)
        || !p3.getIntervalLambda(l3x, l3y, l3z, d3) || !p4.getIntervalLambda(l4x, l4y, l4z, d4))
        return Filtered_Sign::UNCERTAIN;
...
inline int incirclexy_indirect_IIII_bigfloat(const genericPoint& p1,
                                             const genericPoint& p2,
                                             const genericPoint& p3,
                                             const genericPoint& p4)
{
...
inline int incirclexy_indirect_IIII_exact(const genericPoint& p1,
                                          const genericPoint& p2,
                                          const genericPoint& p3,
                                          const genericPoint& p4)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1x_p[16], *l1x = l1x_p, l1y_p[16], *l1y = l1y_p, l1z_p[16], *l1z = l1z_p, d1_p[16], *d1 = d1_p, l2x_p[16],
                      *l2x = l2x_p, l2y_p[16], *l2y = l2y_p, l2z_p[16], *l2z = l2z_p, d2_p[16], *d2 = d2_p, l3x_p[16],
                      *l3x = l3x_p, l3y_p[16], *l3y = l3y_p, l3z_p[16], *l3z = l3z_p, d3_p[16], *d3 = d3_p, l4x_p[16],
                      *l4x = l4x_p, l4y_p[16], *l4y = l4y_p, l4z_p[16], *l4z = l4z_p, d4_p[16], *d4 = d4_p;
    int l1x_len = 16, l1y_len = 16, l1z_len = 16, d1_len = 16, l2x_len = 16, l2y_len = 16, l2z_len = 16, d2_len = 16,
        l3x_len = 16, l3y_len = 16, l3z_len = 16, d3_len = 16, l4x_len = 16, l4y_len = 16, l4z_len = 16, d4_len = 16;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
    p3.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &l3z, l3z_len, &d3, d3_len);
...
inline int incirclexy_indirect_IIII(const genericPoint& p1,
                                    const genericPoint& p2,
                                    const genericPoint& p3,
                                    const genericPoint& p4)
{
...
inline int incircle_indirect_IEEE_interval(const genericPoint& p1,
                                           interval_number     pbx,
                                           interval_number     pby,
                                           interval_number     pcx,
                                           interval_number     pcy,
                                           ...
                                           interval_number     pdy)
{
    ...
    if (!p1.getIntervalLambda(l1x, l1y, d1)) return Filtered_Sign::UNCERTAIN;
...
inline int incircle_indirect_IEEE_bigfloat(const genericPoint& p1,
                                           bigfloat            pbx,
                                           bigfloat            pby,
                                           bigfloat            pcx,
                                           bigfloat            pcy,
...
inline int
    incircle_indirect_IEEE_exact(const genericPoint& p1, double pbx, double pby, double pcx, double pcy, double pdx, double pdy)
{
    double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
    feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
    if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
        return_value = incircle_indirect_IEEE_bigfloat(p1, pbx, pby, pcx, pcy, pdx, pdy);
#endif
...
inline int
    incircle_indirect_IEEE(const genericPoint& p1, double pbx, double pby, double pcx, double pcy, double pdx, double pdy)
{
    int ret;
...
inline int incircle_indirect_IIEE_interval(const genericPoint& p1,
                                           const genericPoint& p2,
                                           interval_number     pcx,
                                           interval_number     pcy,
                                           interval_number     pdx,
                                           interval_number     pdy)
{
    ...
    if (!p1.getIntervalLambda(l1x, l1y, d1) || !p2.getIntervalLambda(l2x, l2y, d2)) return Filtered_Sign::UNCERTAIN;
...
inline int incircle_indirect_IIEE_bigfloat(const genericPoint& p1,
                                           const genericPoint& p2,
                                           bigfloat            pcx,
                                           bigfloat            pcy,
                                           bigfloat            pdx,
...
inline int incircle_indirect_IIEE_exact(const genericPoint& p1,
                                        const genericPoint& p2,
                                        double              pcx,
                                        double              pcy,
                                        double              pdx,
                                        double              pdy)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1x_p[32], *l1x = l1x_p, l1y_p[32], *l1y = l1y_p, d1_p[32], *d1 = d1_p, l2x_p[32], *l2x = l2x_p, l2y_p[32],
                      *l2y = l2y_p, d2_p[32], *d2 = d2_p;
...
inline int incircle_indirect_IIEE(const genericPoint& p1,
                                  const genericPoint& p2,
                                  double              pcx,
                                  double              pcy,
                                  double              pdx,
...
inline int incircle_indirect_IIIE_interval(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           interval_number     pdx,
                                           interval_number     pdy)
{
    ...
    if (!p1.getIntervalLambda(l1x, l1y, d1) || !p2.getIntervalLambda(l2x, l2y, d2) || !p3.getIntervalLambda(l3x, l3y, d3))
        return Filtered_Sign::UNCERTAIN;
...
inline int incircle_indirect_IIIE_bigfloat(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           bigfloat            pdx,
                                           bigfloat            pdy)
...
inline int incircle_indirect_IIIE_exact(const genericPoint& p1,
                                        const genericPoint& p2,
                                        const genericPoint& p3,
                                        double              pdx,
                                        double              pdy)
...
#endif
    double l1x_p[32], *l1x = l1x_p, l1y_p[32], *l1y = l1y_p, d1_p[32], *d1 = d1_p, l2x_p[32], *l2x = l2x_p, l2y_p[32],
                      *l2y = l2y_p, d2_p[32], *d2 = d2_p, l3x_p[32], *l3x = l3x_p, l3y_p[32], *l3y = l3y_p, d3_p[32],
                      *d3 = d3_p;
    int l1x_len = 32, l1y_len = 32, d1_len = 32, l2x_len = 32, l2y_len = 32, d2_len = 32, l3x_len = 32, l3y_len = 32,
        d3_len = 32;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &d2, d2_len);
...
inline int incircle_indirect_IIIE(const genericPoint& p1,
                                  const genericPoint& p2,
                                  const genericPoint& p3,
                                  double              pdx,
                                  double              pdy)
...
inline int incircle_indirect_IIII_interval(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           const genericPoint& p4)
{
...
inline int incircle_indirect_IIII_bigfloat(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           const genericPoint& p4)
{
...
inline int incircle_indirect_IIII_exact(const genericPoint& p1,
                                        const genericPoint& p2,
                                        const genericPoint& p3,
                                        const genericPoint& p4)
{
    ...
    double l1x_p[32], *l1x = l1x_p, l1y_p[32], *l1y = l1y_p, d1_p[32], *d1 = d1_p, l2x_p[32], *l2x = l2x_p, l2y_p[32],
                      *l2y = l2y_p, d2_p[32], *d2 = d2_p, l3x_p[32], *l3x = l3x_p, l3y_p[32], *l3y = l3y_p, d3_p[32],
                      *d3 = d3_p, l4x_p[32], *l4x = l4x_p, l4y_p[32], *l4y = l4y_p, d4_p[32], *d4 = d4_p;
    int l1x_len = 32, l1y_len = 32, d1_len = 32, l2x_len = 32, l2y_len = 32, d2_len = 32, l3x_len = 32, l3y_len = 32,
        d3_len = 32, l4x_len = 32, l4y_len = 32, d4_len = 32;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &d2, d2_len);
    p3.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &d3, d3_len);
...
inline int incircle_indirect_IIII(const genericPoint& p1,
                                  const genericPoint& p2,
                                  const genericPoint& p3,
                                  const genericPoint& p4)
{
...
inline int inSphere_IEEEE_interval(const genericPoint& p1,
                                   interval_number     pbx,
                                   interval_number     pby,
                                   interval_number     pbz,
                                   interval_number     pcx,
...
inline int inSphere_IEEEE_bigfloat(const genericPoint& p1,
                                   bigfloat            pbx,
                                   bigfloat            pby,
                                   bigfloat            pbz,
                                   bigfloat            pcx,
...
inline int inSphere_IEEEE_exact(const genericPoint& p1,
                                double              pbx,
                                double              pby,
                                double              pbz,
                                double              pcx,
...
#ifdef CHECK_FOR_XYZERFLOWS
    if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
        return_value = inSphere_IEEEE_bigfloat(p1, pbx, pby, pbz, pcx, pcy, pcz, pdx, pdy, pdz, pex, pey, pez);
#endif
...
inline int inSphere_IEEEE(const genericPoint& p1,
                          double              pbx,
                          double              pby,
                          double              pbz,
                          double              pcx,
...
inline int inSphere_IIEEE_interval(const genericPoint& p1,
                                   const genericPoint& p2,
                                   interval_number     pcx,
                                   interval_number     pcy,
                                   interval_number     pcz,
...
inline int inSphere_IIEEE_bigfloat(const genericPoint& p1,
                                   const genericPoint& p2,
                                   bigfloat            pcx,
                                   bigfloat            pcy,
                                   bigfloat            pcz,
...
inline int inSphere_IIEEE_exact(const genericPoint& p1,
                                const genericPoint& p2,
                                double              pcx,
                                double              pcy,
                                double              pcz,
...
#endif
    double l1x_p[16], *l1x = l1x_p, l1y_p[16], *l1y = l1y_p, l1z_p[16], *l1z = l1z_p, d1_p[16], *d1 = d1_p, l2x_p[16],
                      *l2x = l2x_p, l2y_p[16], *l2y = l2y_p, l2z_p[16], *l2z = l2z_p, d2_p[16], *d2 = d2_p;
    int l1x_len = 16, l1y_len = 16, l1z_len = 16, d1_len = 16, l2x_len = 16, l2y_len = 16, l2z_len = 16, d2_len = 16;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
    if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
...
#ifdef CHECK_FOR_XYZERFLOWS
    if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
        return_value = inSphere_IIEEE_bigfloat(p1, p2, pcx, pcy, pcz, pdx, pdy, pdz, pex, pey, pez);
#endif
...
inline int inSphere_IIEEE(const genericPoint& p1,
                          const genericPoint& p2,
                          double              pcx,
                          double              pcy,
                          double              pcz,
...
inline int inSphere_IIIEE_interval(const genericPoint& p1,
                                   const genericPoint& p2,
                                   const genericPoint& p3,
                                   interval_number     pdx,
                                   interval_number     pdy,
...
inline int inSphere_IIIEE_bigfloat(const genericPoint& p1,
                                   const genericPoint& p2,
                                   const genericPoint& p3,
                                   bigfloat            pdx,
                                   bigfloat            pdy,
...
inline int inSphere_IIIEE_exact(const genericPoint& p1,
                                const genericPoint& p2,
                                const genericPoint& p3,
                                double              pdx,
                                double              pdy,
                                ...
                                double              pez)
{
    ...
    double l1x_p[16], *l1x = l1x_p, l1y_p[16], *l1y = l1y_p, l1z_p[16], *l1z = l1z_p, d1_p[16], *d1 = d1_p, l2x_p[16],
                      *l2x = l2x_p, l2y_p[16], *l2y = l2y_p, l2z_p[16], *l2z = l2z_p, d2_p[16], *d2 = d2_p, l3x_p[16],
                      *l3x = l3x_p, l3y_p[16], *l3y = l3y_p, l3z_p[16], *l3z = l3z_p, d3_p[16], *d3 = d3_p;
    int l1x_len = 16, l1y_len = 16, l1z_len = 16, d1_len = 16, l2x_len = 16, l2y_len = 16, l2z_len = 16, d2_len = 16,
        l3x_len = 16, l3y_len = 16, l3z_len = 16, d3_len = 16;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
    p3.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &l3z, l3z_len, &d3, d3_len);
    if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
...
#ifdef CHECK_FOR_XYZERFLOWS
    if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
        return_value = inSphere_IIIEE_bigfloat(p1, p2, p3, pdx, pdy, pdz, pex, pey, pez);
#endif
...
inline int inSphere_IIIEE(const genericPoint& p1,
                          const genericPoint& p2,
                          const genericPoint& p3,
                          double              pdx,
                          double              pdy,
...
inline int inSphere_IIIIE_interval(const genericPoint& p1,
                                   const genericPoint& p2,
                                   const genericPoint& p3,
                                   const genericPoint& p4,
                                   interval_number     pex,
...
inline int inSphere_IIIIE_bigfloat(const genericPoint& p1,
                                   const genericPoint& p2,
                                   const genericPoint& p3,
                                   const genericPoint& p4,
                                   bigfloat            pex,
...
inline int inSphere_IIIIE_exact(const genericPoint& p1,
                                const genericPoint& p2,
                                const genericPoint& p3,
                                const genericPoint& p4,
                                double              pex,
...
inline int inSphere_IIIIE(const genericPoint& p1,
                          const genericPoint& p2,
                          const genericPoint& p3,
                          const genericPoint& p4,
                          double              pex,
...
inline int inSphere_IIIII_interval(const genericPoint& p1,
                                   const genericPoint& p2,
                                   const genericPoint& p3,
                                   const genericPoint& p4,
...
inline int inSphere_IIIII_bigfloat(const genericPoint& p1,
                                   const genericPoint& p2,
                                   const genericPoint& p3,
                                   const genericPoint& p4,
                                   const genericPoint& p5)
...
inline int inSphere_IIIII_exact(const genericPoint& p1,
                                const genericPoint& p2,
                                const genericPoint& p3,
                                const genericPoint& p4,
                                const genericPoint& p5)
{
    ...
    double l1x_p[8], *l1x = l1x_p, l1y_p[8], *l1y = l1y_p, l1z_p[8], *l1z = l1z_p, d1_p[8], *d1 = d1_p, l2x_p[8], *l2x = l2x_p,
                     l2y_p[8], *l2y = l2y_p, l2z_p[8], *l2z = l2z_p, d2_p[8], *d2 = d2_p, l3x_p[8], *l3x = l3x_p, l3y_p[8],
                     *l3y = l3y_p, l3z_p[8], *l3z = l3z_p, d3_p[8], *d3 = d3_p, l4x_p[8], *l4x = l4x_p, l4y_p[8], *l4y = l4y_p,
                     l4z_p[8], *l4z = l4z_p, d4_p[8], *d4 = d4_p, l5x_p[8], *l5x = l5x_p, l5y_p[8], *l5y = l5y_p, l5z_p[8],
                     *l5z = l5z_p, d5_p[8], *d5 = d5_p;
    int l1x_len = 8, l1y_len = 8, l1z_len = 8, d1_len = 8, l2x_len = 8, l2y_len = 8, l2z_len = 8, d2_len = 8, l3x_len = 8,
        l3y_len = 8, l3z_len = 8, d3_len = 8, l4x_len = 8, l4y_len = 8, l4z_len = 8, d4_len = 8, l5x_len = 8, l5y_len = 8,
        l5z_len = 8, d5_len = 8;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
    p3.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &l3z, l3z_len, &d3, d3_len);
...
inline int inSphere_IIIII(const genericPoint& p1,
                          const genericPoint& p2,
                          const genericPoint& p3,
                          const genericPoint& p4,
                          const genericPoint& p5)
...
inline bool lambda2d_SSI_interval(interval_number  ea1x,
                                  interval_number  ea1y,
                                  interval_number  ea2x,
                                  interval_number  ea2y,
                                  interval_number  eb1x,
                                  interval_number  eb1y,
                                  interval_number  eb2x,
                                  interval_number  eb2y,
                                  interval_number& lambda_x,
                                  interval_number& lambda_y,
...
inline void lambda2d_SSI_bigfloat(bigfloat  ea1x,
                                  bigfloat  ea1y,
                                  bigfloat  ea2x,
                                  bigfloat  ea2y,
                                  bigfloat  eb1x,
...
inline void lambda2d_SSI_exact(double   ea1x,
                               double   ea1y,
                               double   ea2x,
                               double   ea2y,
                               double   eb1x,
...
inline bool lambda3d_LNC_interval(interval_number  px,
                                  interval_number  py,
                                  interval_number  pz,
                                  interval_number  qx,
                                  interval_number  qy,
...
inline void lambda3d_LNC_bigfloat(bigfloat  px,
                                  bigfloat  py,
                                  bigfloat  pz,
                                  bigfloat  qx,
                                  bigfloat  qy,
...
inline void lambda3d_LNC_exact(double   px,
                               double   py,
                               double   pz,
                               double   qx,
                               double   qy,
...
inline bool lambda3d_LPI_interval(interval_number  px,
                                  interval_number  py,
                                  interval_number  pz,
                                  interval_number  qx,
                                  interval_number  qy,
...
inline void lambda3d_LPI_bigfloat(bigfloat  px,
                                  bigfloat  py,
                                  bigfloat  pz,
                                  bigfloat  qx,
                                  bigfloat  qy,
...
inline void lambda3d_LPI_exact(double   px,
                               double   py,
                               double   pz,
                               double   qx,
                               double   qy,
...
inline bool lambda3d_TPI_interval(interval_number  ov1x,
                                  interval_number  ov1y,
                                  interval_number  ov1z,
                                  interval_number  ov2x,
                                  interval_number  ov2y,
                                  interval_number  ov2z,
                                  interval_number  ov3x,
                                  interval_number  ov3y,
                                  interval_number  ov3z,
                                  interval_number  ow1x,
                                  interval_number  ow1y,
                                  interval_number  ow1z,
                                  interval_number  ow2x,
                                  interval_number  ow2y,
                                  interval_number  ow2z,
                                  interval_number  ow3x,
                                  interval_number  ow3y,
                                  interval_number  ow3z,
                                  interval_number  ou1x,
                                  interval_number  ou1y,
                                  interval_number  ou1z,
                                  interval_number  ou2x,
                                  interval_number  ou2y,
                                  interval_number  ou2z,
                                  interval_number  ou3x,
                                  interval_number  ou3y,
                                  interval_number  ou3z,
                                  interval_number& lambda_x,
                                  interval_number& lambda_y,
                                  interval_number& lambda_z,
                                  interval_number& lambda_d)
...
inline void lambda3d_TPI_bigfloat(bigfloat  ov1x,
                                  bigfloat  ov1y,
                                  bigfloat  ov1z,
                                  bigfloat  ov2x,
                                  bigfloat  ov2y,
...
inline void lambda3d_TPI_exact(double   ov1x,
                               double   ov1y,
                               double   ov1z,
                               double   ov2x,
                               double   ov2y,
...
inline int lessThanOnX_II_exact(const genericPoint& p1, const genericPoint& p2)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1x_p[128], *l1x = l1x_p, l1y_p[128], *l1y = l1y_p, l1z_p[128], *l1z = l1z_p, d1_p[128], *d1 = d1_p, l2x_p[128],
                       *l2x = l2x_p, l2y_p[128], *l2y = l2y_p, l2z_p[128], *l2z = l2z_p, d2_p[128], *d2 = d2_p;
...
inline int orient2dxy_indirect_IEE_interval(const genericPoint& p1,
                                            interval_number     p2x,
                                            interval_number     p2y,
                                            interval_number     p3x,
                                            interval_number     p3y)
...
inline int orient2dxy_indirect_IIE_interval(const genericPoint& p1,
                                            const genericPoint& p2,
                                            interval_number     op3x,
                                            interval_number     op3y)
{
    interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
    if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) || !p2.getIntervalLambda(l2x, l2y, l2z, d2)) return Filtered_Sign::UNCERTAIN;
...
inline int orient2dxy_indirect_IIE_exact(const genericPoint& p1, const genericPoint& p2, double op3x, double op3y)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1x_p[64], *l1x = l1x_p, l1y_p[64], *l1y = l1y_p, l1z_p[64], *l1z = l1z_p, d1_p[64], *d1 = d1_p, l2x_p[64],
                      *l2x = l2x_p, l2y_p[64], *l2y = l2y_p, l2z_p[64], *l2z = l2z_p, d2_p[64], *d2 = d2_p;
...
#endif
    double l1x_p[64], *l1x = l1x_p, l1y_p[64], *l1y = l1y_p, l1z_p[64], *l1z = l1z_p, d1_p[64], *d1 = d1_p, l2x_p[64],
                      *l2x = l2x_p, l2y_p[64], *l2y = l2y_p, l2z_p[64], *l2z = l2z_p, d2_p[64], *d2 = d2_p, l3x_p[64],
                      *l3x = l3x_p, l3y_p[64], *l3y = l3y_p, l3z_p[64], *l3z = l3z_p, d3_p[64], *d3 = d3_p;
    int l1x_len = 64, l1y_len = 64, l1z_len = 64, d1_len = 64, l2x_len = 64, l2y_len = 64, l2z_len = 64, d2_len = 64,
        l3x_len = 64, l3y_len = 64, l3z_len = 64, d3_len = 64;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
    p3.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &l3z, l3z_len, &d3, d3_len);
    if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
...
inline int orient2dyz_indirect_IEE_interval(const genericPoint& p1,
                                            interval_number     p2x,
                                            interval_number     p2y,
                                            interval_number     p3x,
                                            interval_number     p3y)
{
    ...
    if (!p1.getIntervalLambda(l1z, l1x, l1y, d1)) return Filtered_Sign::UNCERTAIN;
...
inline int orient2dyz_indirect_IIE_interval(const genericPoint& p1,
                                            const genericPoint& p2,
                                            interval_number     op3x,
                                            interval_number     op3y)
{
    interval_number l1z, l1x, l1y, d1, l2z, l2x, l2y, d2;
    if (!p1.getIntervalLambda(l1z, l1x, l1y, d1) || !p2.getIntervalLambda(l2z, l2x, l2y, d2)) return Filtered_Sign::UNCERTAIN;
...
inline int orient2dyz_indirect_IIE_exact(const genericPoint& p1, const genericPoint& p2, double op3x, double op3y)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1z_p[64], *l1z = l1z_p, l1x_p[64], *l1x = l1x_p, l1y_p[64], *l1y = l1y_p, d1_p[64], *d1 = d1_p, l2z_p[64],
                      *l2z = l2z_p, l2x_p[64], *l2x = l2x_p, l2y_p[64], *l2y = l2y_p, d2_p[64], *d2 = d2_p;
...
inline int orient2dyz_indirect_III_interval(const genericPoint& p1, const genericPoint& p2, const genericPoint& p3)
{
    ...
    if (!p1.getIntervalLambda(l1z, l1x, l1y, d1) || !p2.getIntervalLambda(l2z, l2x, l2y, d2)
...
#endif
    double l1z_p[64], *l1z = l1z_p, l1x_p[64], *l1x = l1x_p, l1y_p[64], *l1y = l1y_p, d1_p[64], *d1 = d1_p, l2z_p[64],
                      *l2z = l2z_p, l2x_p[64], *l2x = l2x_p, l2y_p[64], *l2y = l2y_p, d2_p[64], *d2 = d2_p, l3z_p[64],
                      *l3z = l3z_p, l3x_p[64], *l3x = l3x_p, l3y_p[64], *l3y = l3y_p, d3_p[64], *d3 = d3_p;
    int l1z_len = 64, l1x_len = 64, l1y_len = 64, d1_len = 64, l2z_len = 64, l2x_len = 64, l2y_len = 64, d2_len = 64,
        l3z_len = 64, l3x_len = 64, l3y_len = 64, d3_len = 64;
    p1.getExactLambda(&l1z, l1z_len, &l1x, l1x_len, &l1y, l1y_len, &d1, d1_len);
    p2.getExactLambda(&l2z, l2z_len, &l2x, l2x_len, &l2y, l2y_len, &d2, d2_len);
...
inline int orient2dzx_indirect_IEE_interval(const genericPoint& p1,
                                            interval_number     p2x,
                                            interval_number     p2y,
                                            interval_number     p3x,
                                            interval_number     p3y)
{
    ...
    if (!p1.getIntervalLambda(l1y, l1z, l1x, d1)) return Filtered_Sign::UNCERTAIN;
...
inline int orient2dzx_indirect_IIE_interval(const genericPoint& p1,
                                            const genericPoint& p2,
                                            interval_number     op3x,
                                            interval_number     op3y)
{
    interval_number l1y, l1z, l1x, d1, l2y, l2z, l2x, d2;
    if (!p1.getIntervalLambda(l1y, l1z, l1x, d1) || !p2.getIntervalLambda(l2y, l2z, l2x, d2)) return Filtered_Sign::UNCERTAIN;
...
inline int orient2dzx_indirect_IIE_exact(const genericPoint& p1, const genericPoint& p2, double op3x, double op3y)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1y_p[64], *l1y = l1y_p, l1z_p[64], *l1z = l1z_p, l1x_p[64], *l1x = l1x_p, d1_p[64], *d1 = d1_p, l2y_p[64],
                      *l2y = l2y_p, l2z_p[64], *l2z = l2z_p, l2x_p[64], *l2x = l2x_p, d2_p[64], *d2 = d2_p;
...
inline int orient2dzx_indirect_III_interval(const genericPoint& p1, const genericPoint& p2, const genericPoint& p3)
{
    ...
    if (!p1.getIntervalLambda(l1y, l1z, l1x, d1) || !p2.getIntervalLambda(l2y, l2z, l2x, d2)
...
#endif
    double l1y_p[64], *l1y = l1y_p, l1z_p[64], *l1z = l1z_p, l1x_p[64], *l1x = l1x_p, d1_p[64], *d1 = d1_p, l2y_p[64],
                      *l2y = l2y_p, l2z_p[64], *l2z = l2z_p, l2x_p[64], *l2x = l2x_p, d2_p[64], *d2 = d2_p, l3y_p[64],
                      *l3y = l3y_p, l3z_p[64], *l3z = l3z_p, l3x_p[64], *l3x = l3x_p, d3_p[64], *d3 = d3_p;
    int l1y_len = 64, l1z_len = 64, l1x_len = 64, d1_len = 64, l2y_len = 64, l2z_len = 64, l2x_len = 64, d2_len = 64,
        l3y_len = 64, l3z_len = 64, l3x_len = 64, d3_len = 64;
    p1.getExactLambda(&l1y, l1y_len, &l1z, l1z_len, &l1x, l1x_len, &d1, d1_len);
    p2.getExactLambda(&l2y, l2y_len, &l2z, l2z_len, &l2x, l2x_len, &d2, d2_len);
...
inline int orient2d_indirect_IEE_interval(const genericPoint& p1,
                                          interval_number     p2x,
                                          interval_number     p2y,
                                          interval_number     p3x,
                                          interval_number     p3y)
...
inline int orient2d_indirect_IIE_interval(const genericPoint& p1,
                                          const genericPoint& p2,
                                          interval_number     p3x,
                                          interval_number     p3y)
{
...
inline int orient2d_indirect_IIE_exact(const genericPoint& p1, const genericPoint& p2, double p3x, double p3y)
{
    ...
    feclearexcept(FE_ALL_EXCEPT);
#endif
    double l1x_p[64], *l1x = l1x_p, l1y_p[64], *l1y = l1y_p, d1_p[64], *d1 = d1_p, l2x_p[64], *l2x = l2x_p, l2y_p[64],
                      *l2y = l2y_p, d2_p[64], *d2 = d2_p;
...
#endif
    double l1x_p[64], *l1x = l1x_p, l1y_p[64], *l1y = l1y_p, d1_p[64], *d1 = d1_p, l2x_p[64], *l2x = l2x_p, l2y_p[64],
                      *l2y = l2y_p, d2_p[64], *d2 = d2_p, l3x_p[64], *l3x = l3x_p, l3y_p[64], *l3y = l3y_p, d3_p[64],
                      *d3 = d3_p;
    int l1x_len = 64, l1y_len = 64, d1_len = 64, l2x_len = 64, l2y_len = 64, d2_len = 64, l3x_len = 64, l3y_len = 64,
        d3_len = 64;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &d2, d2_len);
    p3.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &d3, d3_len);
...
inline int orient3d_indirect_IEEE_interval(const genericPoint& p1,
                                           interval_number     ax,
                                           interval_number     ay,
                                           interval_number     az,
                                           interval_number     bx,
...
inline int orient3d_indirect_IEEE_bigfloat(const genericPoint& p1,
                                           bigfloat            ax,
                                           bigfloat            ay,
                                           bigfloat            az,
                                           bigfloat            bx,
...
inline int orient3d_indirect_IEEE_exact(const genericPoint& p1,
                                        double              ax,
                                        double              ay,
                                        double              az,
                                        double              bx,
...
#ifdef CHECK_FOR_XYZERFLOWS
    if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
        return_value = orient3d_indirect_IEEE_bigfloat(p1, ax, ay, az, bx, by, bz, cx, cy, cz);
#endif
...
inline int orient3d_indirect_IEEE(const genericPoint& p1,
                                  double              ax,
                                  double              ay,
                                  double              az,
                                  double              bx,
...
inline int orient3d_indirect_IIEE_interval(const genericPoint& p1,
                                           const genericPoint& p2,
                                           interval_number     p3x,
                                           interval_number     p3y,
                                           interval_number     p3z,
...
inline int orient3d_indirect_IIEE_bigfloat(const genericPoint& p1,
                                           const genericPoint& p2,
                                           bigfloat            p3x,
                                           bigfloat            p3y,
                                           bigfloat            p3z,
...
inline int orient3d_indirect_IIEE_exact(const genericPoint& p1,
                                        const genericPoint& p2,
                                        double              p3x,
                                        double              p3y,
                                        double              p3z,
...
#ifdef CHECK_FOR_XYZERFLOWS
    if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
        return_value = orient3d_indirect_IIEE_bigfloat(p1, p2, p3x, p3y, p3z, p4x, p4y, p4z);
#endif
...
inline int orient3d_indirect_IIEE(const genericPoint& p1,
                                  const genericPoint& p2,
                                  double              p3x,
                                  double              p3y,
                                  double              p3z,
...
inline int orient3d_indirect_IIIE_interval(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           interval_number     p4x,
                                           interval_number     p4y,
...
inline int orient3d_indirect_IIIE_bigfloat(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           bigfloat            p4x,
                                           bigfloat            p4y,
...
inline int orient3d_indirect_IIIE_exact(const genericPoint& p1,
                                        const genericPoint& p2,
                                        const genericPoint& p3,
                                        double              p4x,
                                        double              p4y,
...
inline int orient3d_indirect_IIIE(const genericPoint& p1,
                                  const genericPoint& p2,
                                  const genericPoint& p3,
                                  double              p4x,
                                  double              p4y,
...
inline int orient3d_indirect_IIII_interval(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           const genericPoint& p4)
{
...
inline int orient3d_indirect_IIII_bigfloat(const genericPoint& p1,
                                           const genericPoint& p2,
                                           const genericPoint& p3,
                                           const genericPoint& p4)
{
...
inline int orient3d_indirect_IIII_exact(const genericPoint& p1,
                                        const genericPoint& p2,
                                        const genericPoint& p3,
                                        const genericPoint& p4)
{
    ...
    double l1x_p[32], *l1x = l1x_p, l1y_p[32], *l1y = l1y_p, l1z_p[32], *l1z = l1z_p, d1_p[32], *d1 = d1_p, l2x_p[32],
                      *l2x = l2x_p, l2y_p[32], *l2y = l2y_p, l2z_p[32], *l2z = l2z_p, d2_p[32], *d2 = d2_p, l3x_p[32],
                      *l3x = l3x_p, l3y_p[32], *l3y = l3y_p, l3z_p[32], *l3z = l3z_p, d3_p[32], *d3 = d3_p, l4x_p[32],
                      *l4x = l4x_p, l4y_p[32], *l4y = l4y_p, l4z_p[32], *l4z = l4z_p, d4_p[32], *d4 = d4_p;
    int l1x_len = 32, l1y_len = 32, l1z_len = 32, d1_len = 32, l2x_len = 32, l2y_len = 32, l2z_len = 32, d2_len = 32,
        l3x_len = 32, l3y_len = 32, l3z_len = 32, d3_len = 32, l4x_len = 32, l4y_len = 32, l4z_len = 32, d4_len = 32;
    p1.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
    p2.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
    p3.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &l3z, l3z_len, &d3, d3_len);
    p4.getExactLambda(&l4x, l4x_len, &l4y, l4y_len, &l4z, l4z_len, &d4, d4_len);
...
inline int orient3d_indirect_IIII(const genericPoint& p1,
                                  const genericPoint& p2,
                                  const genericPoint& p3,
                                  const genericPoint& p4)
{
